...
𝐀𝐯𝐢𝐬𝐨 𝐩𝐚𝐫𝐚 𝐯𝐨𝐜𝐞 𝐪𝐮𝐞 𝐬𝐚𝐢𝐮 @${num.split('@')[0]} 𝐁𝐨𝐢 𝐛𝐨𝐢 𝐛𝐨𝐢,𝐛𝐨𝐢 𝐝𝐚 𝐜𝐚𝐫𝐚 𝐩𝐫𝐞𝐭𝐚 𝐪𝐮𝐞𝐦 𝐬𝐚𝐢𝐮 𝐝𝐨 𝐠𝐫𝐮𝐩𝐨 𝐦𝐚𝐦𝐚 𝐚 𝐩𝐢𝐤𝐚 𝐝𝐨 𝐜𝐚𝐩𝐞𝐭𝐚😂👋`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const apiKey = setting.apiKey // contact me on whatsapp wa.me/6796945218
			...
			const ownerNumber = [`${setting.ownerNumber}@s.whatsapp.net`] // 556796945218
            const mod = [ownerNumber,"${setting.mod}@s.whatsapp.net"]//96945218
            const adminbotnumber = ["${setting.adminbotnumber}@s.whatsapp.net"]//6796945218
			const frendsowner = ["${setting.frendsowner}@s.whatsapp.net"]//556796945218
